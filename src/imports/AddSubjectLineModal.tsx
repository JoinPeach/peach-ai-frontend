  ...
  return (
    <div className="content-stretch flex items-center justify-end overflow-clip relative shrink-0 w-[459px]" data-name="div">
      <div className="flex flex-col font-['SF_Pro:Regular',_sans-serif] font-normal justify-center leading-[0] max-w-[544px] relative shrink-0 text-[#6c6685] text-[13.234px] text-nowrap text-right tracking-[-0.1px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[normal] whitespace-pre">0/140</p>
      </div>
    </div>
  );
}
...
export default function AddSubjectLineModal() {
  return (
    <div className="bg-white relative rounded-[16px] shadow-[0px_4px_50px_0px_rgba(33,33,33,0.08),0px_4px_6px_0px_rgba(33,33,33,0.04)] size-full" data-name="add subject line modal">
      <div className="relative size-full">
