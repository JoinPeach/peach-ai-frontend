  ...
  return (
    <div className="bg-white h-[100px] relative rounded-[12px] shrink-0 w-full" data-name="Input">
      <div className="overflow-clip relative size-full">
        <div className="box-border content-stretch flex h-[100px] items-start p-[16px] relative w-full">
          <div className="basis-0 flex flex-col font-['SF_Pro:Regular',_sans-serif] font-normal grow justify-center leading-[0] max-w-[544px] min-h-px min-w-px relative shrink-0 text-[#212121] text-[15px] tracking-[-0.1px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="leading-[normal]">This is for students who have missing documents in their FAFSA application, the documents missing are tax returns.</p>
          </div>
        </div>
      </div>
...
export default function AiEmailGeneratorModal3() {
  return (
    <div className="bg-white relative rounded-[16px] shadow-[0px_4px_50px_0px_rgba(33,33,33,0.08),0px_4px_6px_0px_rgba(33,33,33,0.04)] size-full" data-name="ai email generator modal 3">
